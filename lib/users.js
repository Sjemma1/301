...
getLocationById = function(userId){
  return getLocation(Meteor.users.findOne(userId));
};

getSite = function(user){
    return user.profile.site;
};

getSiteById = function(userId){
  return getSite(Meteor.users.findOne(userId));
};
...
getPhoneById = function(user){
  return getPhone(Meteor.users.findOne(userId));
};

getDribbble = function(user){
    return user.profile.dribbble;
};

getDribbbleById = function(user){
  return getDribbble(Meteor.users.findOne(userId));
};
...
getBioById = function(userId){
  return getBio(Meteor.users.findOne(userId));
};
